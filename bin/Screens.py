...
class StatsScreen(BaseScreen):
    ...
    def render(self):
        ...
        if(self.display.icon_stats == 'text'):
            ...
            self.display.draw.text((0, 3), str(chr(62609), 'utf-8'), font=self.font(18, is_icon=True), fill=255)
            self.display.draw.text((65, 3), str(chr(62776), 'utf-8'), font=self.font(18, is_icon=True), fill=255)
            self.display.draw.text((0, 23), str(chr(63426), 'utf-8'), font=self.font(18, is_icon=True), fill=255)
            self.display.draw.text((65, 23), str(chr(62171), 'utf-8'), font=self.font(18, is_icon=True), fill=255)
            self.display.draw.text((0, 43), str(chr(61931), 'utf-8'), font=self.font(18, is_icon=True), fill=255)
